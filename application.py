...
app.layout = html.Div(children=[
    ...
    html.Div([ 
        ...
        html.Label('Select the average monthly hours of the employee in the company'),
        Avg_Monthly_hours_dropdown  ,
        html.Label('Select the time spent by the employee in the company'),
        time_dropdown,
        html.Label('Select if the work accident is done by the employee in the company'),
        html.Label('(1 for Yes, 0 for No)'),
        time_Work_accident_dropdown, 
        html.Label('Was the employee promoted last year(1 for Yes, 0 for No)'),
        promotion_dropdown,
